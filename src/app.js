...
function sweetTooth(totalNoOfSweets, sweetsConsumedByKaren, sweetsConsumedInNMeters, metersToTravel) {
    if (
      totalNoOfSweets === 0 && sweetsConsumedByKaren === 0 && sweetsConsumedInNMeters === 0 && metersToTravel === 0
    )
      return 0;
    ...
    if (
      totalNoOfSweets == undefined && sweetsConsumedByKaren == undefined && sweetsConsumedInNMeters == undefined && metersToTravel == undefined
    )
